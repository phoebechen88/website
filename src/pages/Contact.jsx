    ...
    <section className="section-card">
      <div className="container contact-top-row">
        ...
        <div className="link-grid contact-links">
          <a href="mailto:phoebechen2040@gmail.com" aria-label="Email" className="contact-icon" title="Email">
          ...
          <a href="https://github.com/phoebechen88" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="contact-icon" title="GitHub">
